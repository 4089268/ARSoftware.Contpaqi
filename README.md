...
Este repositorio es un **fork** de [ARSoftware.Contpaqi.Comercial](https://github.com/AndresRamos/ARSoftware.Contpaqi.Comercial) con el propósito de exponer las funcionalidades básicas de **Compaqi** a través de un servicio **Web API**.  

Para lograrlo, se agregó un nuevo proyecto **ASP.NET Core Web API** a la solución original.
...
- **Dependencia:** Tener instalado **Compaqi** en la máquina  


## Uso
1. Abrir una terminal en la carpeta del proyecto `CompaqWebAPI`.  
2. Ejecutar los siguientes comandos con el CLI de .NET:

```bash
# Instalar o comprobar dependencias
dotnet restore
