...
public static class FacturaElectronicaSdk
{
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fAltaCuentaBancariaCliente")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fAltaCuentaBancariaEmpresa")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fBorraCuentaBancariaCliente")]
    public static extern int fBorraCuentaBancariaCliente(string aCuentaBancaria, string aCodigoCliente);

    [DllImport("MGW_SDK.dll", EntryPoint = "fBorraCuentaBancariaEmpresa")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fCancelaDocumentoAdministrativamente")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fCuentaBancariaEmpresaDoctos")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fGetDatosCFDI")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fInicioSesionSDKCONTPAQi")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fModificaCuentaBancariaCliente")]
    ...
    [DllImport("MGW_SDK.dll", EntryPoint = "fModificaCuentaBancariaEmpresa")]
