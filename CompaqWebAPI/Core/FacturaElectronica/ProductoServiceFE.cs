...
{
    public class ProductoServiceFE : IProductoService
    {
        /// <summary>
        ...
        public void ActualizarProducto(Producto producto)
        {
            ...
            FacturaElectronicaSdk.fBuscaProducto(producto.Codigo).TirarSiEsError();

            // Activar el modo de edición
            FacturaElectronicaSdk.fEditaProducto().TirarSiEsError();

            // Actualizar los campos del registro donde el SDK esta posicionado
            FacturaElectronicaSdk.fSetDatoProducto("CNOMBREPRODUCTO", producto.Nombre).TirarSiEsError();

            FacturaElectronicaSdk.fSetDatoProducto("CTIPOPRODUCTO", producto.Tipo.ToString()).TirarSiEsError();

            // Guardar los cambios realizados al registro
            FacturaElectronicaSdk.fGuardaProducto().TirarSiEsError();
        }
        ...
        public Producto BuscarProductoPorCodigo(string productoCodigo)
        {
            // Buscar el producto por código
            // Si el producto existe el SDK se posiciona en el registro
            FacturaElectronicaSdk.fBuscaProducto(productoCodigo).TirarSiEsError();
        ...
        public Producto BuscarProductoPorId(int productoId)
        {
            ...
            // Si el producto existe el SDK se posiciona en el registro
            FacturaElectronicaSdk.fBuscaIdProducto(productoId).TirarSiEsError();
        ...
        public List<Producto> BuscarProductos()
        {
            ...
            int resultado = FacturaElectronicaSdk.fPosPrimerProducto();
            ...
            while (FacturaElectronicaSdk.fPosSiguienteProducto() == SdkConstantes.CodigoExito)
            {
                // Leer los datos del registro donde el SDK esta posicionado
                productosList.Add(LeerDatosProducto());
                ...
                if (FacturaElectronicaSdk.fPosEOFProducto() == 1) break;
            }
        ...
        public int CrearProducto(Producto producto)
        {
            ...
            FacturaElectronicaSdk.fAltaProducto(ref productoNuevoId, ref productoNuevo).TirarSiEsError();
        ...
        public void EliminarProducto(Producto producto)
        {
            ...
            FacturaElectronicaSdk.fBorraProducto().TirarSiEsError();
        }
        ...
        private Producto LeerDatosProducto()
        {
            ...
            // Leer los datos del registro donde el SDK esta posicionado
            FacturaElectronicaSdk.fLeeDatoProducto("CIDPRODUCTO", idBd, 3000).TirarSiEsError();
            FacturaElectronicaSdk.fLeeDatoProducto("CCODIGOPRODUCTO", codigoBd, 3000).TirarSiEsError();
            FacturaElectronicaSdk.fLeeDatoProducto("CNOMBREPRODUCTO", nombreBd, 3000).TirarSiEsError();
            FacturaElectronicaSdk.fLeeDatoProducto("CTIPOPRODUCTO", tipoBd, 3000).TirarSiEsError();
